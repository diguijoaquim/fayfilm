...
function HomePage() {
  ...
  const handleTrailerClick = () => {
    window.open('https://www.youtube.com/watch?v=coKW0ake9SM', '_blank');
  };
          ...
          <div className="md:w-2/3">
            ...
            <div className="bg-gray-900 p-6 rounded-lg mb-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                Uma história emocionante de vingança e amor familiar. ONDTWE,
                nascido em uma família humilde, vê sua vida transformada quando
                seu irmão mais novo é sequestrado. Após bandidos descobrirem a
                riqueza de seu pai na produção de gado, exigem um resgate de
                50.000,00MT. O que começa como uma simples negociação se
                transforma em uma busca implacável por justiça quando os
                sequestradores alegam ter matado seu irmão.
              </p>
            </div>
            ...
            <div className="bg-red-900/30 p-6 rounded-lg mb-8">
              ...
              <p className="text-gray-300 mb-6">
                Ajude-nos a continuar produzindo cinema de qualidade em
                Moçambique. Sua contribuição faz a diferença!
              </p>
          ...
          <div className="md:w-1/3">
            <div className="bg-gray-900 p-6 rounded-lg sticky top-4">
              ...
              <ul className="space-y-4 text-gray-300">
                ...
                <li>
                  <strong className="text-red-500">Site criado por:</strong>{' '}
                  Ghost04
                </li>
              </ul>
              ...
              <div className="mt-8">
                <button 
                  ...
                  className="w-full bg-red-600 hover:bg-red-700 px-6 py-3 rounded-lg flex items-center justify-center gap-2"
                >
                  <Play size={20} />
                  Assistir Trailer
                </button>
